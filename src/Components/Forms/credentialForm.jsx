    ...
    return (
        <div className="">
            <BackgroundGradient className="rounded-[22px] max-w-md  bg-white dark:bg-zinc-900">
                <div className="max-w-md min-w-96 w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
                    ...
                    <form className="my-8" onSubmit={handleSubmit}>
                        ...
                        <LabelInputContainer className="mb-4">
                            ...
                            <Input id="email" placeholder="Write a message" type="text" />
                        </LabelInputContainer>
